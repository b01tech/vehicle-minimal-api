...
namespace VehicleControl.API.Exceptions {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Esta placa já está sendo utilizada.
        /// </summary>
        public static string LICENCE_PLATE_ALREADY_REGISTERED {
            get {
                return ResourceManager.GetString("LICENCE_PLATE_ALREADY_REGISTERED", resourceCulture);
            }
        }
